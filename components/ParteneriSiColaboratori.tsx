...
const ParteneriSiColaboratori = () => {
  ...
  return (
    <div className="flex flex-col justify-center gap-[4rem] items-center lg:px-[4rem] my-[7rem] xl:mt-[8rem] xl:px-[7rem] 2xl:px-[17rem] 1780px:px-[20rem]">
      <h1 className="lg:text-[64px] text-[32px] font-mustica-semibold text-white">
        Parteneri și Colaboratori
      </h1>
      <div className="SLIDER w-full inline-flex flex-nowrap overflow-hidden">
